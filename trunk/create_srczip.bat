...
cd ..
cd Update\
copy ..\..\Update\update.example.ini
copy ..\..\Update\Updater.dpr
copy ..\..\Update\Updater.dproj
copy ..\..\Update\Updater.drc

cd ..
copy ..\ASuite - Install script.nsi
copy ..\ASuite.dpr
copy ..\ASuite.dproj
copy ..\ASuite.drc
copy ..\ASuite.res
copy ..\Card.dfm
copy ..\Card.pas
copy ..\CheckPrevious.pas
copy ..\ClassicSpeedButton.zip
copy ..\ClearElements.dfm
copy ..\ClearElements.pas
copy ..\CommonClasses.pas
copy ..\CommonUtils.pas
copy ..\ImportList.dfm
copy ..\ImportList.pas
...
copy ..\Menu.dfm
copy ..\Menu.pas
copy ..\MenuFolders.dfm
copy ..\MenuFolders.pas
copy ..\Option.dfm
copy ..\Option.pas
...
copy ..\PropertyGroup.dfm
copy ..\PropertyGroup.pas
copy ..\PropertySw.dfm
copy ..\PropertySw.pas
copy ..\RunAs.dfm
copy ..\RunAs.pas
...
c:\programmi\7-zip\7z.exe a -tzip ..\asuite152src.zip
